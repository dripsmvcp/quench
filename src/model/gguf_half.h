...
// rescale must multiply fp16/bf16 scales by 0.0625 in the FLOAT domain — an
// exponent-bit-subtract trick is wrong for small scales (biased exponent 0 ->
// left unscaled, 16x too large; exponents 1..4 -> flushed to zero), which
// corrupts Q8_0 gpt-oss weights and produces garbage output. These
