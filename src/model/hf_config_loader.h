...
struct HFConfigLoader {
    ...
    // to arch-family defaults or the hard-coded QuenchGenerateParams baseline.
    ...
    // Detection-only today; quench does not yet have an AWQ dequant kernel.
    struct AWQConfig {
    ...
    // Map HF architecture class name to quench ModelArch.
