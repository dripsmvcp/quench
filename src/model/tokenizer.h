...
private:
    ...
    // BERT WordPiece (, nomic-bert embedder): lowercase basic tokenizer +
...
// Qwen2/Qwen3 pre-tokenizer scan (canonical regex segmentation;).
...
// o200k pre-tokenizer scan (gpt-oss / GPT-4o family;). Case-aware letter
...
// cl100k pre-tokenizer scan (GPT-4/tiktoken lineage, Phi-4;): qwen2
