...
struct ModelConfig {
    ...
    // not stored — the single source, instead of hand-deriving it at
    ...
    // AWQ pre-quantized model. Detection-only today — quench does not yet
    ...
    // singleton" smell goes away. Populated from quench.conf (legacy
...
struct TransformerLayer {
    ...
    // Encoder post-LN biases (, nomic-bert): true LayerNorm with bias,
