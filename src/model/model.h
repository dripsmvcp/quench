...
public:
    ...
    // access — Engine::init rejects it up front. Reload the model for a
    ...
    // Encoder embedder extras (, nomic-bert): post-embedding LayerNorm
    ...
    bool sources_consumed_ = false;         // Phase-4b freed source tensors
