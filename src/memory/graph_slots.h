...
//
// Without slots, CudaGraphConditionalRunner::setup() allocates 13 device
// buffers and 4 pinned host buffers, and cleanup() frees them again — once
// per burst, which the --wrap interposer measures as the whole of the
// steady-state allocation traffic (238 of 238 calls).
//
...
// (memory/host_pinned.h). It lives there rather than here because it
// is a tier, not a detail of this pool.
// Substituting it is what makes this pool testable in the
