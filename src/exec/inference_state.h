...
struct InferenceState {
    ...
    // path: the chunk rows are presented as n_sequences same-KV
    ...
    // Spec-verify chunk forward: small-M GEMMs may read the NVFP4
    ...
    // remain to shut the document. -1 = unknown, no narrowing.
    ...
    // Graph-captured verify chunk. When ctx_capacity > 0 the chunked
