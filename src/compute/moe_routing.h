...
// gpt-oss router bias (issue): true linear bias on the gate LOGITS, added
...
// gpt-oss per-expert output biases (issue).
...
// FP32-input variant for diagnostic QUENCH_GEMMA4_FP32_EXPERT_DOWN.
...
// variant is used by run_moe_ffn.
