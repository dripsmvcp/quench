...
// The identities of the kernel paths quench can resolve to, as plain enums.
//
...
enum class AttnPrefillPath {
    ...
    NONE,        // chain exhausted → attention_prefill_dispatch throws
};
...
enum class AttnPrefillOuter {
    ...
    CUBLAS_SLICED,  // attention_cublas_prefill_sliced — hd=512 S-matrix overflow
