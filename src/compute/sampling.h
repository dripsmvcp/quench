...
// whole batch — a per-sequence pageable readback serializes batched decode
// against ~200 us host round-trips each (29% GPU idle at n=16).
...
// blocks run one-at-a-time (~10% of GPU time at n=16, per nsys).
