...
// simulator, for token-level constrained decoding.
//
// WHY A SECOND ENGINE. quench already pins JSON (free-form and schema), the tool
// dialects and — — a regular expression. A regex covers the formats
