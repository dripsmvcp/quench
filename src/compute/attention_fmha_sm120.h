...
//) — a virtual extra logit column with no V contribution, folded into
...
// compound per-layer noise into prompt-blind output (/). Bq=64 only
...
// replays ( graph-captured verify). fp16_qk path only.
