...
// Graph-capturable variant. All per-expert state lives on the
...
// wrapper above inside the MoE prefill dispatch once that wiring lands.
//
...
struct GroupedNvfp4DeviceArgs {
    ...
    // B/SFB storage. Two modes (mutually exclusive):
    //
