...
#define QUENCH_DP4A_QUANT_TYPES(X) \
    X(q6k, Q6_K_Traits)         \
    X(q8_0, Q8_0_Traits)        \
    X(q4_0, Q4_0_Traits)        \
    X(q4_k, Q4_K_Traits)        \
...
#define QUENCH_DEFINE_GEMV_DP4A(name, traits)                                                                   \
...
QUENCH_DP4A_QUANT_TYPES(QUENCH_DEFINE_GEMV_DP4A)
#undef QUENCH_DEFINE_GEMV_DP4A
...
#define QUENCH_DEFINE_GEMV_DP4A_QKV(name, traits)                                                           \
...
QUENCH_DP4A_QUANT_TYPES(QUENCH_DEFINE_GEMV_DP4A_QKV)
#undef QUENCH_DEFINE_GEMV_DP4A_QKV
