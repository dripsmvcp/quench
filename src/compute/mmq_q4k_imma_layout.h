...
// Q4_K_M → symmetric-s8 reorder for the INT8 IMMA direct-GEMM kernel.
//
...
//
// A layout permutation suited to `ldmatrix.x4` fragment loads could be added
// later; the s8 tensor stays plain row-major K-major to make the unit test
// trivial — the permutation only matters to the consuming tile kernel.
