...
//                   TOOL_CALL body FSM constrains the arguments ( strict:
...
public:
    ...
    // of an OPTIONAL (model-chosen) tool call — OpenAI `strict: true`.
    ...
    // FSM-constrained — the constrainer engages its TOOL_CALL body
    ...
    //: TOOL_ARGS → ACTIVE so free text / EOS / another tool opener all
