...
// Instrumentation-only probe for contextual FFN sparsity. Counts, for each of
...
// resets the counters.
//
// Off unless ffn.sparsity_probe = true in quench.conf. When off, the public functions
