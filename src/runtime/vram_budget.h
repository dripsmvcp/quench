...
struct VRAMBudget {
    ...
    // starve a cache the PLAN has already granted. Unconditional:
    // the guarantee is the floor itself, not
...
//
// The mandatory native-NVFP4 decode caches are not physically pre-reserved
// by any Engine-held balloon: KV is charged
...
// instead of 278/280, dropping decode 38% while ~11 GiB sat free.
...
//: raw dtype_size() returns 0 for NVFP4/MXFP4_KV (zeroing the
