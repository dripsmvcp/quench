...
public:
    ...
    // Enforced tool calling: constrain generation to a tool-call
    ...
    // Constrain output to a regular expression. The
    ...
    // Constrain output to a GBNF grammar. Same contract
    ...
    // Jump-ahead, schema only (json_mode has no schema skeleton to
