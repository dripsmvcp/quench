...
struct ProcessDiag {
    ...
    bool attention_fa2_hd256 = true;  // matches the config.h default (on
...
void process_diag_install(const RuntimeConfig& cfg) {
    ...
    // level: the whole point of this key is making the level settable,
    // and a typo that quietly resolves to INFO would defeat that.
    {
        LogLevel lvl;
