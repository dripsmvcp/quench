...
bool process_diag_fa2_f16acc();  // f16-accumulate QK^T in the fp16-qk FA2 kernel
bool process_diag_fa2_pv_f16acc();  // f16-accumulate the PV MMA too ( follow-up)
...
bool process_diag_fa2_hd256();  // HD=256 FA2 port (attention.fa2_hd256, default on
void process_diag_set_fa2_hd256(bool v);
bool process_diag_fp8_qk_scaled();  // amax-scaled e4m3 fp8-QK
...
// NVFP4-attention spike knobs (only meaningful when mxfp4 == "always").
