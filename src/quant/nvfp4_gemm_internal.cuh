#ifndef QUENCH_QUANT_NVFP4_GEMM_INTERNAL_CUH
#define QUENCH_QUANT_NVFP4_GEMM_INTERNAL_CUH
...
__device__ __forceinline__ float dot_micro_block(const uint8_t* __restrict__ pb, const half* __restrict__ x,
    ...
    // L1TEX data path (~90%) while DRAM idled at ~70% ( lever-3
...
#endif  // QUENCH_QUANT_NVFP4_GEMM_INTERNAL_CUH
