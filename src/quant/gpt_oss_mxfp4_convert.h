...
// gpt-oss checkpoint conversion (issue): HF-MXFP4 packed experts →
// quench's native NVFP4 MoE cache (NvFP4MoEQuantResult).
//
...
// against transformers' integrations/mxfp4.py unpack and quench's split-layout
...
// results so quench's standard MoE machinery applies unchanged.
