# quench Agent Skills — Index

Project-scoped skills for agentic work on quench (`.claude/skills/*/SKILL.md`). Each
...
| [server-api](server-api/SKILL.md) | quench-server endpoints (OpenAI + Anthropic), streaming, json_schema, tool calling, cache_control, validation tools | check-degeneration |
...
| [codebase-audit](codebase-audit/SKILL.md) | Structural-debt / dead-code / god-file / flag audits + the verification discipline that stops fan-out over-flagging | building-and-testing, check-degeneration |
| [docs-sync](docs-sync/SKILL.md) | Keeping architecture.md / README / docs/GOAL.md / supported-models.md / quench.conf.example / CHANGELOG coherent after a change; English-only rule | benchmark-cuda (perf), codebase-audit |
