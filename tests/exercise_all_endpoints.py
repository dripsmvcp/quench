#!/usr/bin/env python3
"""MANUAL tool — not wired into ctest/CI. Needs a running
quench-server on :8080 with a tool-capable model (default Qwen3-8B-NVFP4-cortecs).

Drives every quench-server endpoint and mode once — OpenAI chat/completions/
...
B = os.environ.get("QUENCH_BASE", "http://localhost:8080").rstrip("/")
