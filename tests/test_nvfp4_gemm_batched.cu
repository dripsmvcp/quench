// gemm_nvfp4_batched: batched-M FP16-output NVFP4 GEMM for spec-verify
// chunks. Without it the verify chunk forward (M = 2..33 rows) takes the M>1
...
// Accumulate (beta=1) variant for the o/down residual-add GEMMs:
