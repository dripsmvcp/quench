#!/usr/bin/env bash
# Compare quench vs llama.cpp output quality for complex structured prompts.
# Tests multiple prompts with different penalty settings.
# Usage: ./test_repetition_compare.sh [quench|llama|both]
set -euo pipefail
...
echo "=== quench Server Repetition Test ==="
