...
#
# Environment:
#   QUENCH_MOCK_PORT  - mock server port (default: 9099)
#
...
export QUENCH_USE_MOCK=1
export QUENCH_MOCK_PORT="${QUENCH_MOCK_PORT:-9099}"

echo "=== Running API tests against mock server (port ${QUENCH_MOCK_PORT}) ==="
