...
// json_object grammar. This file attacks the schema-driven side, where
// (runaway digit run), (backslash in keys) and (minItems/maxItems
...
// ===========================================================================
// P4 — minItems enforcement: closing an array before minItems are
...
// ===========================================================================
// — the schema FSM carried the same permissive number grammar as
