#!/usr/bin/env python3
"""Generate golden reference outputs from HuggingFace models for testing quench.
...
The quench test harness loads these .npy files and compares against quench's
