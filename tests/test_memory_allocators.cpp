...
// The property that lets the grow-on-demand
// scratches in compute/ live here. Those pointers are kernel
// PARAMETERS baked into instantiated CUDA graphs. A cudaFree+cudaMalloc
// grow makes a replayed graph read a freed address; an arena grow must leave the
