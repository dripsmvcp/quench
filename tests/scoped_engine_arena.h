...
#define QUENCH_TEST_ENGINE_ARENA(bytes)                                                           \
    static ::testing::Environment* const quench_arena_env_ = ::testing::AddGlobalTestEnvironment( \
        new ::quench::EngineArenaEnvironment(bytes))
