...
Needs a running quench-server with a chat model (default Qwen3-8B-NVFP4-cortecs).
...
def stream_events():
    ...
    Stops as soon as `message_stop` arrives — quench-server keeps the chunked
    ...
    """
    # `thinking:disabled` is best-effort: quench's underlying /no_think suppression
