...
// `^...$` deliberately does NOT sit in the list above. It is the most natural
// way to write a
// pattern, and refusing it means a client asking for `^[0-9]{3}$` gets free-form
