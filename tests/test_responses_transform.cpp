// Unit tests for tools/quench-server/responses.{h,cpp} — the /v1/responses
...
// OpenAI Agents SDK and Codex CLI send/expect) — no quench-vs-quench.
...
using quench_server::responses::json;
using quench_server::responses::openai_to_responses_response;
using quench_server::responses::responses_to_openai_body;
