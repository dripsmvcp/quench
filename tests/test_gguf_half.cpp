...
// GGUF 2^-4 residual rescale. These lock in the PR fix: the rescale MUST be
...
// range — including denormals and small exponents, which a bit-shift shortcut
// gets wrong (denormal -> unchanged = 16x too big; exp 1..4 -> zero).
