...
Needs a running quench-server with a THINK-capable model (default Qwen3-8B-NVFP4-cortecs).
...
Env:  QUENCH_BASE (default http://localhost:8080), QUENCH_MODEL (auto from /v1/models)
