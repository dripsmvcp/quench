...
// Enforced tool calling: collect (name, parameter-schema JSON) pairs
...
// Strict OPTIONAL tool calling (OpenAI `strict: true` with tool_choice
...
// Llama3 forced tool calling: `<function=NAME>{JSON args}</function>` —
